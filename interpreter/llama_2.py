...
def get_llama_2_instance():
    ...
    models = {
        "7B": {
            "Low": {
                "URL": "https://huggingface.co/TheBloke/CodeLlama-7B-Instruct-GGUF/resolve/main/codellama-7b-instruct.Q3_K_S.gguf",
                "Size": "3.01 GB",
                "RAM": "5.51 GB",
            },
            "Medium": {
            ...
            "High": {
                "URL": "https://huggingface.co/TheBloke/CodeLlama-7B-Instruct-GGUF/resolve/main/codellama-7b-instruct.Q8_0.gguf",
                "Size": "7.16 GB",
                "RAM": "9.66 GB",
            },
        },
        "13B": {
            "Low": {
                "URL": "https://huggingface.co/TheBloke/CodeLlama-13B-Instruct-GGUF/resolve/main/codellama-13b-instruct.Q3_K_S.gguf",
                "Size": "5.66 GB",
                "RAM": "8.16 GB",
            },
            "Medium": {
            ...
            "High": {
                "URL": "https://huggingface.co/TheBloke/CodeLlama-13B-Instruct-GGUF/resolve/main/codellama-13b-instruct.Q8_0.gguf",
                "Size": "13.83 GB",
                "RAM": "16.33 GB",
            },
        },
        "34B": {
            "Low": {
                "URL": "https://huggingface.co/TheBloke/CodeLlama-34B-Instruct-GGUF/resolve/main/codellama-34b-instruct.Q3_K_S.gguf",
                "Size": "14.21 GB",
                "RAM": "16.71 GB",
            },
            "Medium": {
            ...
            "High": {
                "URL": "https://huggingface.co/TheBloke/CodeLlama-34B-Instruct-GGUF/resolve/main/codellama-34b-instruct.Q8_0.gguf",
                "Size": "35.79 GB",
                "RAM": "38.29 GB",
            },
        },
    ...
    quality_choices = [
        format_quality_choice(quality, models[chosen_param][quality])
        for quality in models[chosen_param]
    ]

    questions = [
        inquirer.List(
            "quality",
            message="Quality (lower is faster, higher is more capable)",
            choices=quality_choices,
        )
    ]
    answers = inquirer.prompt(questions)
    chosen_quality = answers["quality"].split(" ")[
        0
    ]  # Extracting the 'small', 'medium', or 'large' from the selected choice
    ...
    llama_2 = Llama(
        model_path=model_path, n_gpu_layers=n_gpu_layers, verbose=False, n_ctx=1048
    )  # n_ctx = context window. smaller is faster
